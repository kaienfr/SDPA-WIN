/*
 * @(#)mclmcr.h    generated by: makeheader 5.1.5  Fri Jul  8 14:08:49 2011
 *
...
EXTERN_C bool mclmcrInitialize2(int primaryMode);
...
EXTERN_C bool mclRegisterEventFunction(HMCRINSTANCE inst, const char* varname, mclEventFunctionPtr fcn);
