...
public:
    ...
    virtual void invoke(void *context, const char* lpszName, int nargin, ...) = 0;
    virtual void invokeA(void *context, const char* lpszName, int nargin, mxArray** prhs) = 0;
    virtual void invokeV(void *context, const char* lpszName, int nargin, va_list vargs) = 0;
};
...
public:
    ...
    void invoke(void *context, const char* lpszName, int nargin, ...)
    {
        mwLock lock;
        std::map<void *, IMCLEvent*>::iterator it = m_events.find(context);
        if (it != m_events.end())
    ...
    // Invokes the named event in the listener of current call context.
    void invokeA(void *context, const char* lpszName, int nargin, mxArray** prhs)
    {
        mwLock lock;
        std::map<void *, IMCLEvent*>::iterator it = m_events.find(context);
        if (it != m_events.end())
    ...
    // Invokes the named event in the listener of current call context.
    void invokeV(void *context, const char* lpszName, int nargin, va_list vargs)
    {
        mwLock lock;
        std::map<void *, IMCLEvent*>::iterator it = m_events.find(context);
        if (it != m_events.end())
